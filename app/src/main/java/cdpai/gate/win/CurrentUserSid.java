...
public final class CurrentUserSid {
    ...
    public static String resolve() {
        try (var arena = Arena.ofConfined()) {
            ...
            if ((int) OpenProcessToken.invoke(hProcess, TOKEN_QUERY, hTokenBox) == 0)
            ...
            if ((int) GetTokenInformation.invoke(hToken, TokenUser, buf, 256, retLen) == 0)
                throw lastError("GetTokenInformation(TokenUser)");
            ...
            if ((int) ConvertSidToStringSidW.invoke(psid, strBox) == 0)
                throw lastError("ConvertSidToStringSidW");
