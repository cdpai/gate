...
@Command(name = "cdpg", mixinStandardHelpOptions = true, version = "cdpg 0.2",
    ...
    footer = {
        ...
        "  2. cdpg approve --profiles SHR --domains youtube.com --minutes 120",
        "                                                          once, at the start: a human approves in a window,",
        "                                                          anchored at the agent; later calls pass silently",
        "  3. cdpg send Target.getTargets --profiles SHR --domains youtube.com     the tabs you may use",
        ...
        "    cdpg send Network.getAllCookies --target <tabId> --profiles SHR --domains youtube.com",
